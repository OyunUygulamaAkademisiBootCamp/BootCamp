...
public class CharacterMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 leftPos = new Vector3(charPos.x - distance, charPos.y, charPos.z);
        Vector3 rightPos = new Vector3(charPos.x + distance, charPos.y, charPos.z);
        charPos = tf.position;
        ...
        {
            transform.position = Vector3.Lerp(transform.position, leftPos, 1f);
            ...
            if (Input.GetKeyDown(KeyCode.RightArrow) && line < 2)
            {
                ...
                transform.position = Vector3.Lerp(transform.position, rightPos, 1f);
